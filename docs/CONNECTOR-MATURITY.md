...
|---|---|---|
| **01 Revenue-Cycle Denials (hero)** | Denials — documented **X12 835 / HealthLake** scaffold | 1 · fixture + documented scaffold (no clean public denial API) |
| 01 Revenue-Cycle Denials | Payer/clearinghouse 835 feed, Epic/ADT (customer) | **4 · not done** (engagement, under BAA) |
| 02–08 | Prior-auth, clinical-admin, patient-access, UM, payment-integrity, care-mgmt, contact-center | 1 · fixture (tier 4 = engagement) |
