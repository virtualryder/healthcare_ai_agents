...
| **HIPAA / AWS BAA** | With `LLM_PROVIDER=bedrock`, the clinical rationale is drafted on HIPAA-eligible Bedrock, reached via PrivateLink — no PHI egress to an external AI API. |
