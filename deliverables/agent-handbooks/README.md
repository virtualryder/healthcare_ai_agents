...
**Maturity stance (every agent):** Demonstrated + Deployable-by-design today (142 tests pass with
no API key). Production-readiness — CSV/CSA validation, IdP federation, live connectors,
