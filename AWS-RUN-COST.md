# AWS Run-Cost Model — Healthcare Payer/Provider (HPP)
...
below is for **Agent 01 (Revenue-Cycle Denials)** at pilot scale.*
...
with real figures from the Pricing Calculator**. Data class for this pack: PHI under BAA → PrivateLink required.
