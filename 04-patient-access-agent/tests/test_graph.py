"""Graph wiring test — skipped if langgraph absent; asserts the HITL interrupt."""
import sys
...
def test_graph_has_hitl_interrupt():
    ...
    from agent.graph import build_patient_access_graph
    g = build_patient_access_graph(use_memory=True)
