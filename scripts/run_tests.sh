...
for a in 01-revenue-cycle-denial-agent 02-prior-authorization-agent 03-clinical-administration-agent 04-patient-access-agent 05-utilization-management-agent 06-payment-integrity-coding-agent; do
