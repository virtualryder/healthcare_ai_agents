# Release Packet — Healthcare Payer/Provider (HPP)
...
- **Implementation package (`hpp-agent-platform`):** semantic version, moves with code (may change without an AGP change).
